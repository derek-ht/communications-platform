...
def test_message_id_of_different_dm(set_up_member_dm_with_owner_message):
    ...
    response = requests.put(url + "message/edit/v1", json = pload)
...
# Tests editing own message as owner of channel
def test_edit_as_owner(set_up_owner):
...
# Tests editing own message as member of channel
def test_edit_as_member(set_up_member):
...
# Tests deleting own message as owner
def test_delete_as_owner(set_up_owner):
    token, message_id, channel_id = set_up_owner
...
# Tests deleting own message as member
def test_delete_as_member(set_up_member):
    token, message_id, channel_id = set_up_member[0:3]
...
# Testing when edited message is 1000 char
def test_edit_1000_char_message(set_up_member):
    token, message_id, channel_id = set_up_member[0:3]
    new_long_message = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\
...
aaaaaaaaaa"
    ...
    assert message["message"] == new_long_message


# Testing when edited message is too long
def test_too_long_message(set_up_member):
...
# Testing when message_id invalid
def test_invalid_message_id(set_up_member):
    token, message_id = set_up_member[0:2]
    invalid_message_id = message_id + 1
    new_message = "edited_message"
...
# Tests owner of channel editing another person's message
def test_edit_others_message_as_owner(set_up_member):
    others_message_id, channel_id, owner_token = set_up_member[1:4]
...
# Tests member of channel editing another person's message
def test_edit_others_message_as_member(set_up_owner):
    owner_token, message_id, channel_id = set_up_owner
    new_message = "editied_message"
